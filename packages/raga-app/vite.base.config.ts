/**
 * @file Vite base configuration.
 * @see https://github.com/electron/forge/blob/1aa94fc32754ffd07a3652db42952f1f22ddbd6c/packages/template/vite-typescript/tmpl/vite.base.config.ts
 */
